 ...
 * AURA Bloom Icons
 * 
 * SVG icon set for the bloom menu system.
...
export const AIIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7">
    <path d="M12 2a4 4 0 0 1 4 4c0 1.5-.8 2.8-2 3.5L14 12h-4l0-2.5c-1.2-.7-2-2-2-3.5a4 4 0 0 1 4-4z"/>
    <path d="M12 12v4"/>
    <path d="M9 18h6"/>
    <path d="M10 22h4"/>
