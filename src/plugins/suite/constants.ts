...
// A generic plugin for unimplemented components
import { PlaceholderPlugin } from './components/plugins/PlaceholderPlugin';


export const PLUGIN_TIERS = {
  'Core Tier': {
    'MixxTune': { id: "mixx-tune", tier: "core", parameters: ["retuneSpeed", "formant", "humanize", "mix", "emotiveLock"], lightingProfile: { hueStart: 210, hueEnd: 330, motion: "float" }, moodResponse: "Follows lyric sentiment and section changes; adjusts mood confidence.", name: 'Mixx Tune', description: 'AI vocal tuner and tone-former.', component: MixxTune },
    ...
    'MixxDelay': { id: "mixx-delay", tier: "core", parameters: ["time", "feedback", "mix", "throwIntuition"], lightingProfile: { hueStart: 300, hueEnd: 300, motion: "pulse" }, moodResponse: "Syncs to tempo; throws more during chorus.", name: 'Mixx Delay', description: 'Intelligent throw delay.', component: MixxDelay },
    ...
    'MixxGlue': { id: "mixx-glue", tier: "core", parameters: ["threshold", "ratio", "release", "mix"], lightingProfile: { hueStart: 270, hueEnd: 270, motion: "pulse" }, moodResponse: "Smooths transitions; softens build-up.", name: 'Mixx Glue', description: 'Bus compressor / cohesion.', component: MixxGlue, canBeSidechainTarget: true },
  },
  'Neural Tier': {
    ...
    'PrimeEQ': { id: "prime-eq", tier: "neural", parameters: ["lowGain", "midGain", "highGain", "smartFocus"], lightingProfile: { hueStart: 180, hueEnd: 270, motion: "pulse" }, moodResponse: "Balances frequency bands dynamically; smooth color drift.", name: 'Prime EQ', description: 'Adaptive AI EQ.', component: PrimeEQ },
  ...
  'Master Tier': {
    'MixxLimiter': { id: "mixx-limiter", tier: "master", parameters: ["ceiling", "drive", "lookahead", "clubCheck"], lightingProfile: { hueStart: 0, hueEnd: 0, motion: "pulse" }, moodResponse: "Tightens headroom; reacts to song peaks.", name: 'Mixx Limiter', description: 'Loudness and ceiling controller.', component: MixxLimiter, canBeSidechainTarget: true },
  ...
  'System Tier': {
    ...
    'MixxPort': { id: "mixx-port", tier: "system", parameters: ["format", "quality"], lightingProfile: { hueStart: 270, hueEnd: 270, motion: "pulse" }, moodResponse: "Fires completion glow when render done.", name: 'Mixx Port', description: 'Export engine for Mixx file type.', component: MixxPort },
...
export const INITIAL_PLUGIN_STATES: PluginStates = {
  // Core Tier
  MixxTune: { ...baseDefaults, retuneSpeed: 50, formant: 50, humanize: 50, emotiveLock: false },
  ...
  PrimeMasterEQ: { ...baseDefaults, lowShelfFreq: 120, lowShelfGain: 0, highShelfFreq: 8000, highShelfGain: 0, midSideMode: false },
  MixxDither: { ...baseDefaults, bitDepth: 16, noiseShaping: 'low', ditherAmount: 100 },
  // Signature Tier
  ...
  MixxPort: { ...baseDefaults, format: 'mixx', quality: 90 },
