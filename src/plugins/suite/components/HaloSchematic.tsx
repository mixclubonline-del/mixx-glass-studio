          ...
          return (
            ...
            >
              ...
              {ring.plugins.map((pluginKey, pluginIndex) => {
                ...
                return (
                  <div key={pluginKey} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 group" 
                    style={{ 
                        transform: `translate(${pos.x}px, ${pos.y}px) rotate(-${ringIndex * 10}deg)`,
                    }}
                  >
                    <div
                      className="w-full h-full rounded-full cursor-pointer relative transition-all duration-300 ease-out hover:scale-125 hover:shadow-cyan-400/50"
                      style={{ 
